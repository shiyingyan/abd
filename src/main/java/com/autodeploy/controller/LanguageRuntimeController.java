...
public class LanguageRuntimeController {
    ...
    @Autowired
    private LanguageRuntimeService runtimeService;
    ...
    @ResponseBody
    public java.util.Map<String, Object> checkInstalled(@RequestParam String language, @RequestParam String version) {
