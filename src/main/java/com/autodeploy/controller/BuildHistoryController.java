...
public class BuildHistoryController {
    ...
    public String historyPage(@RequestParam(defaultValue = "1") int page,
                              ...
                              Model model) {
        Page<BuildRecord> records = historyService.queryRecords(page, 15, projectName, status, dateFrom, dateTo);
    ...
    @ResponseBody
    public ResponseEntity<Map<String, String>> getLog(@PathVariable Long id) {
        String content = historyService.getLogContent(id);
        Map<String, String> result = new HashMap<>();
        result.put("content", content != null ? content : "无日志");
