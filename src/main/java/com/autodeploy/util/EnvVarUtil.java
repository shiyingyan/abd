...
/**
 * Utility for reading environment variables by key. Config records store only the env var key name;
 * the actual value is read from the OS environment at runtime via System.getenv().
 */
