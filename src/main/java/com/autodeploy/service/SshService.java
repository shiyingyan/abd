...
public class SshService {
     ...
     */
    public String executeCommand(String host, int port, String user, String password, String command) throws Exception {
     ...
     */
    public void uploadFile(String host, int port, String user, String password,
     ...
     */
    public void downloadFile(String host, int port, String user, String password,
