...
public class GitService {
    ...
    /**
     * Build credentials provider based on URL type.
     * HTTPS: use token as password (works with GitHub/GitLab/Bitbucket personal access tokens).
     * SSH: token is used as passphrase (typically empty for key-based auth without passphrase).
     */
