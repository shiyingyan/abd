...
public enum LanguageType {
    JAVA(
        "SDKMAN",
        // Unix: SDKMAN
        "sdk use java %s", "sdk list java", "sdk install java %s",
        // Windows: check java -version
        "java -version", "java -version", "echo Please install JDK manually on Windows"
    ),
    GO(
        "gvm",
        // Unix: gvm
        "gvm use %s", "gvm list", "gvm install %s",
        // Windows: go version
        "go version", "go version", "echo Please install Go manually on Windows"
    ),
    NODE(
        "nvm",
        // Unix: nvm
        "nvm use %s", "nvm ls", "nvm install %s",
        // Windows: nvm-windows (nvm list / nvm install)
        "nvm use %s", "nvm list", "nvm install %s"
    ),
    PYTHON(
        "uv",
        // Unix: uv
        "uv venv", "uv python list", "uv python install %s",
    ...
    LanguageType(String toolName,
                 String useCommandPattern, String listCommand, String installCommandPattern,
                 String useCommandPatternWin, String listCommandWin, String installCommandPatternWin) {
