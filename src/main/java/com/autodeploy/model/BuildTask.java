...
public class BuildTask {
    ...
    public BuildTask(String taskId, ProjectConfig configSnapshot, String buildMode, String currentUser) {
        this.taskId = taskId;
    ...
    public ProjectConfig getConfigSnapshot() { return configSnapshot; }
    public void setConfigSnapshot(ProjectConfig configSnapshot) { this.configSnapshot = configSnapshot; }

    public String getBuildMode() { return buildMode; }
    public void setBuildMode(String buildMode) { this.buildMode = buildMode; }

    public BuildTaskStatus getStatus() { return status; }
    public void setStatus(BuildTaskStatus status) { this.status = status; }
