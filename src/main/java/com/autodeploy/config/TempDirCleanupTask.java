...
/**
 * Scheduled task to clean up per-user git temp directories older than 7 days.
...
public class TempDirCleanupTask {
    ...
    public void cleanup() {
        ...
        log.info("Temp directory cleanup completed. Deleted {} directories older than {} days.", deletedCount, RETENTION_DAYS);
    }
